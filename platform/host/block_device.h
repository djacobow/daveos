...
namespace daveos::platform::host {
  ...
  // Regular-file media, opened read-only by default. Explicit open; no heap,
  // mapping or global instance. The file/device must outlive every attached
  // Volume. All calls use the same application thread. Open/close reject
  // mounted-media leases.
