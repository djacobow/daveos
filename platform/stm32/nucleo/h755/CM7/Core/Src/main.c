...
#endif
/* M4 paints its full remaining SRAM before entering stop. Allow that
   bounded startup work when M7 boots directly, without the bootloader. */
static const int32_t kBootSyncBudget = 1000000;
